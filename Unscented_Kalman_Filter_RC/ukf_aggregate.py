...
def grid_poly(width,length,bin_size):
    "corridor square polygon generator for station sim"
    "ukf should work with any list of connected simple polys whose union cobers space of interest"
    polys = []
...
def calc_point(poly_list,points):
    counts = []
